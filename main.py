...
app_key = ubinascii.unhexlify('4ABCC7051577F9BCD4BD952E1A63D87A')
dev_eui = ubinascii.unhexlify('70B3D57ED0051BC5')
...
# Measure the sensors
batteryVoltage,WaterLevel,waterTempCelsius,temperatureC,pressurehPa,relHumidity=measure(messageNumber)
...
WaterLevelMeters=int(WaterLevel)
...
payload=ustruct.pack(">HhhhhhhI",messageNumber,batmV,WaterLevelMeters,waterTempCentigradeCelsius,TempCentigrade,pressurehPa,relHumiditypermil,unixtimesecs)
