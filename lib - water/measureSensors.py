...
def measure(messageNumber):
    ...
    while True:
        waterTempCelsius=measureTemperature(ow)
    ...
    print("Water temperature (degrees C) = %7.1f" % waterTempCelsius)
...
# ************************************#
    def measureWaterLevel():
        ...
        while True:
            depth = (round((voltage - VOLTAGE_INIT), 2)) * (RANGE/ DENSITY_WATER / 2.64) #Calculate depth from voltage readings
    ...
    try:
        ...
        f.write('{:11d},{:8.3f},{:6.3f},{:6.3f},{:7.1f},{:7.1f},{:7.1f},{:10d})\n'.format(utime.time(),batteryVoltage,waterTempCelsius,WaterLevel,temperatureC,pressurehPa,relHumidity,messageNumber))  # write data to file
    ...
    return(batteryVoltage,WaterLevel,waterTempCelsius,temperatureC,pressurehPa,relHumidity)
